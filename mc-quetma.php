 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Thanh Toán Ví Điện Tử
 * Description:       Thanh toán quét mã QR cho các ví điện tử phổ biến tại Việt Nam
 * Version:           1.2.6
 * Author:            Multitab
 * Author URI:        https://multitab.io.vn
 * License:           GPL-2.0+
 ...
 */
define( 'MC_QUETMA_VERSION', '1.2.6' );
